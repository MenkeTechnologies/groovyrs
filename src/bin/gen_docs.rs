...
fn main() {
    ...
    .replace("__GROOVYRS_VERSION__", env!("CARGO_PKG_VERSION"));
...
fn build_body(corpus: &[CEntry]) -> String {
    ...
    for (chapter, entries) in &chapters {
        // The `id="ch-…"` marks this as a real reference chapter.
        let _ = write!(
            out,
    ...
    <header class="tutorial-header">
      <div class="tutorial-header-inner">
        <div>
          ...
          <p class="docs-build-line">groovyrs v__GROOVYRS_VERSION__ · Groovy on fusevm · lex/parse → AST → bytecode → Cranelift JIT · no bespoke VM, no JVM · MIT · in active development</p>
        </div>
        <div class="tutorial-toolbar">
          ...
          <a class="btn btn-secondary" href="https://github.com/MenkeTechnologies/groovyrs" target="_blank" rel="noopener noreferrer">GitHub</a>
        </div>
      </div>
    </header>
...
const FOOT: &str = r#"
      <section class="tutorial-section">
        ...
        <ul>
          ...
          <li><strong>Source</strong> — <a href="https://github.com/MenkeTechnologies/groovyrs">github.com/MenkeTechnologies/groovyrs</a></li>
        </ul>
      </section>
    </main>
