...
//!
//! `groovy --tiers script.groovy` prints the report.
...
pub struct ChunkTiers {
    /// Which chunk this is — `main` for a whole Groovy program.
    pub name: String,
...
/// has gone round enough times to be recorded. groovyrs writes program output
